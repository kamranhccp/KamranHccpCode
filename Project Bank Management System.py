...
customerNames = ['HASNAT', 'KAMRAN', 'FIZZA', 'RAZA', 'HAMZA', 'ASMA', 'HAIDER', 'ADIL', 'LAIBA', 'ALEESHA', 'HASNAIN', 'ABUZAR']
customerAge = [18, 17, 19, 18, 19, 18, 18, 19, 20, 19, 20, 20]
customerPins = ['0123', '2575', '7275', '5049', '3453', '2533', '4363', '5334', '8006', '4646', '5456', '5444']
customerPhNumber = ['31787382', '3242223', '23223232', '32323222', '54532242', '22433537', '434343366', '64764644', '747844684', '67454635', '53533337', '353630953']
customerBalances = [10000, 20000, 40000, 10000, 23003, 20000, 90000, 23000, 54005, 45005, 12000, 54000]
adminID = ['kamran771878', 'hasnat785879']
adminPassword = ['dj&8Hj?sh', 'hj#bdG9w@']
deposition = 0
withdrawal = 0
balance = 0
i = 0
...
while True:
    ...
    if choiceNumber == "1":
        ...
        print("\nPlease Enter your Details to Open your Account!")
        ...
        pin = str(input("Create a Pin for your Account: "))
        ...
        if deposition < 500:
            ...
            print("Account Created SuccessfulL! Customer Details added to System!")
            print("\n")
